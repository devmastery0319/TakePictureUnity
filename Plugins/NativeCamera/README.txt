...
Online documentation & example code available at: https://github.com/devmastery/UnityNativeCamera
E-mail: devmastery@gmail.com
...
- (optional) change the values of 'Camera Usage Description' and 'Microphone Usage Description' at 'Project Settings/devmastery/Native Camera'

2.2.b. Manual Setup for iOS
- set the value of 'Automated Setup' to false at 'Project Settings/devmastery/Native Camera'
- build your project
...
4. SCRIPTING API
Please see the online documentation for a more in-depth documentation of the Scripting API: https://github.com/devmastery/UnityNativeCamera
