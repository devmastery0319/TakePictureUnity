...
- import [NativeCamera.unitypackage](https://github.com/devmastery/UnityNativeCamera/releases) via *Assets-Import Package*
- clone/[download](https://github.com/devmastery/UnityNativeCamera/archive/master.zip) this repository and move the *Plugins* folder to your Unity project's *Assets* folder
...
- *(via Package Manager)* add the following line to *Packages/manifest.json*:
  - `"com.devmastery.nativecamera": "https://github.com/devmastery/UnityNativeCamera.git",`
- *(via [OpenUPM](https://openupm.com))* after installing [openupm-cli](https://github.com/openupm/openupm-cli), run the following command:
  - `openupm add com.devmastery.nativecamera`
...
For reference, the legacy documentation is available at: https://github.com/devmastery/UnityNativeCamera/wiki/Manual-Setup-for-Android

### iOS Setup

There are two ways to set up the plugin on iOS:

- **a. Automated Setup:** *(optional)* change the values of **Camera Usage Description** and **Microphone Usage Description** at *Project Settings/devmastery/Native Camera*
- **b. Manual Setup:** see: https://github.com/devmastery/UnityNativeCamera/wiki/Manual-Setup-for-iOS

## FAQ

- **Can't use the camera, it says "java.lang.ClassNotFoundException: com.devmastery.unity.NativeCamera" in Logcat**
